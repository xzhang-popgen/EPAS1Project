...
def run_abc_variable_selection_time(n,q):
    print (n)
    # file names
    old_par_file_name = DIR + 'ModelB_adaptive_intro_scaled_admixture_2bot-younger.par'
    #old_par_file_name_admixture = DIR + 'adaptive_intro_scaled_tib_demo_simple.par'
    new_par_file_name = DIR + str(array_id)+'adaptive_intro_scaled_admixture_%d.par' %n
...
if __name__=='__main__':
    ...
    outfile_name = '/u/scratch/x/xinjunzh/epas1/cluster_result_mine/400k_100-2bot-young1160_f+l'+str(array_id)+'.out' #output file name
