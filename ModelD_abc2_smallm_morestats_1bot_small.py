...
def run_abc_variable_selection_time(n,q):
    print (n)
    # file names
    old_par_file_name = DIR + 'ModelC_adaptive_intro_scaled_admixture_1bot_small_0.1.par'
    #old_par_file_name_admixture = DIR + 'adaptive_intro_scaled_tib_demo_simple.par'
    new_par_file_name = DIR + str(array_id)+'adaptive_intro_scaled_admixture_small_%d.par' %n
    outfile_name_evolve_2 = DIR + str(array_id)+'evolve-small_2_%d.out' %n
...
if __name__=='__main__':
    ...
    outfile_name = '/u/scratch/x/xinjunzh/epas1/cluster_result_mine/400k_100-1bot-0.01_f+l'+str(array_id)+'.out' #output file name
